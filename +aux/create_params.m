...
% CLUSTER PARAMETERS
%------------------
Jplus = 8;% 8 % intra-cluster potentiation factor for E clusters
...
feat(scnt).profile = @(t)gain; % square pulse stimulus
...
save(paramsfile,'ni_ext','tau_arp','tau_i','tau_e','tau_E_r_AMPA','tau_E_d_AMPA',...
    'tau_E_r_NMDA','tau_E_d_NMDA','tau_I_r_AMPA','tau_I_d_AMPA','tau_I_r_NMDA','tau_I_d_NMDA','theta_e',...
